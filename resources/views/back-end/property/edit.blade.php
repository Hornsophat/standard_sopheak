    ...
    <main class="app-content">
        <div class="app-title">
            <ul class="app-breadcrumb breadcrumb side">
                ...
                <li class="breadcrumb-item active"><a href="#">{{ __('item.edit_property') }}</a></li>
            </ul>
        </div>
        <div class="tile">
            <div class="tile-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <h3>{{ __('item.edit_property') }}</h3><hr/>
                            ...
                            <div class="panel-body">
                                ...
                                {!! Form::open(array('url' => 'property/'.$item->id.'/edit', 'files' => true)) !!}
                                ...
                                <div class="row">
                                    <div class="col-lg-6 form-group"  style="font-family: 'Times New Roman', Times, serif">
                                        ...
                                        {{ Form::select('project', $projects ?? [], $item->project_id ?? '', ['class' => 'form-control project_id'])}}
                                    </div>
                                    ...
                                    <div class="col-lg-6 form-group"  style="font-family: 'Times New Roman', Times, serif">
                                        ...
                                        <select name="status" id="property_type" class="form-control">
                                ...
                                <div class="row">
                                   <div class="col-md-6"​  style="font-family:Khmer OS System;">
                                       <div class="form-group"  >
                                            ...
                                            {!! Form::text('property_name', $item->property_name, array('class' => 'form-control')) !!}
                                        </div>
                                   </div> 
                                   <div class="col-md-6"> 
                                       <div class="form-group"  style="font-family: 'Times New Roman', Times, serif">
                                ...
                                <div class="row">   
                                    ...
                                    <div class="col-md-6"  style="font-family: 'Times New Roman', Times, serif">
                                        ...
                                        {!! Form::text('product_first', $item->product_first, array('class' => 'form-control')) !!}
                                    </div>
                                     <div class="col-md-6"  style="font-family: 'Times New Roman', Times, serif">
                                        {!! Form::label('product_second', trans('Product')) !!}
                                        {!! Form::text('product_second', $item->product_second, array('class' => 'form-control')) !!}
                                    </div>
                                     <div class="col-md-6"  style="font-family: 'Times New Roman', Times, serif">
                                        {!! Form::label('product_third', trans('Product')) !!}
                                        {!! Form::text('product_third', $item->product_third, array('class' => 'form-control')) !!}
                                    </div>
                                     <div class="col-md-6"  style="font-family: 'Times New Roman', Times, serif">
                                        {!! Form::label('product_four', trans('Product ')) !!}
                                        {!! Form::text('product_four', $item->product_four, array('class' => 'form-control')) !!}
                                    </div>
                                    <div class="col-md-6"  style="font-family: 'Times New Roman', Times, serif">
                                        {!! Form::label('product_five', trans('Product')) !!}
                                        {!! Form::text('product_five', $item->product_five, array('class' => 'form-control')) !!}
                                    </div>
                            </div>        
