                                            ...
                                            @foreach($item as $key => $value)
                                                <tr>
                                                    ...
                                                    @if(Auth::user()->can('edit-property') || $isAdministrator)
                                                        <a class="btn btn-sm btn-info" href="{{ URL::to('property/' . $value->id . '/edit') }}">{{trans('item.edit')}}</a>
                                                    ...
                                                    @endif
                                                        <div class="btn-group">
                                                            ...
                                                            <div class="dropdown-menu">
                                                                ...
                                                                <a class="dropdown-item" href="{{ route('sale_property.sale', ['property'=>$value]) }}"><i class="fa fa-shopping-cart"></i>{{trans('លក់')}}</a>
                                                                @if($value->status==1)
