                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <table class="table">
                                            ...
                                            <tr>
                                                <td>&emsp;{{ trans('Product') }}</td>
                                                <td>{{ $item->product_first }}</td>
                                            </tr>
                                            <tr>
                                                <td>&emsp;{{ trans('Product') }}</td>
                                                <td>{{ $item->product_second }}</td>
                                            </tr>
                                            <tr>
                                                <td>&emsp;{{ trans('Product') }}</td>
                                                <td>{{ $item->product_third }}</td>
                                            </tr>
                                            <tr>
                                                <td>&emsp;{{ trans('Product') }}</td>
                                                <td>{{ $item->product_four }}</td>
                                            </tr>
                                            <tr>
                                                <td>&emsp;{{ trans('Product') }}</td>
                                                <td>{{ $item->product_five }}</td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td>&emsp;{{ trans('item.village') }}</td>
                                                <td>{{ $item->village }}</td>
                                            </tr>
                                            <tr>
                                                <td>&emsp;{{ trans('item.commune') }}</td>
                                                <td>{{ $item->commune }}</td>
                                            </tr>
                                            <tr>
                                                <td>&emsp;{{ trans('item.district') }}</td>
                                                <td>{{ $item->district}}</td>
                                            </tr>
                                            <tr>
                                                <td>&emsp;{{ trans('item.province') }}</td>
                                                <td>{{ $item->province }}</td>
                                            </tr>
                                            @if($abouts)
                                            <tr>
