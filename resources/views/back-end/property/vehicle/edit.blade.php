    ...
    <main class="app-content">
        <div class="app-title">
            <ul class="app-breadcrumb breadcrumb side">
                ...
                <li class="breadcrumb-item active"><a href="#">{{ __('item.edit_vehicle') }}</a></li>
            </ul>
        </div>
        <div class="tile">
            <div class="tile-body">
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                {!! Form::open(array('url' => 'property/vehicle/'.$item->id.'/edit', 'files' => true)) !!}

                                <div class="row">
                                    <div class="col-md-6 form-group" style="font-family: 'Times New Roman', Times, serif;">
                                        ...
                                        <div class="col-md-6"> 
                                            <div class="input-group" style="font-family: 'Times New Roman', Times, serif;">
                                                     ...
                                                     {!! Form::text('number_plate', $item->number_plate, array('class' => 'form-control','oninput'=>"this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');")) !!}
                                    ...
                                    <div class="col-lg-4 form-group mt-2" style = "display:none;" style="font-family: 'Times New Roman', Times, serif;"> 
