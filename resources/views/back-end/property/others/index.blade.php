    ...
    <main class="app-content">
        <div class="app-title">
            <ul class="app-breadcrumb breadcrumb side">
                ...
                <li class="breadcrumb-item active"><a href="#">{{ __('item.list_others') }}</a></li>
            </ul>
        </div>
        <div class="tile">
            <div class="tile-body">
                                            ...
                                            @foreach($item as $key => $value)
                                                <tr>
                                                    ...
                                                    @if(Auth::user()->can('edit-property') || $isAdministrator)
                                                        <a class="btn btn-sm btn-info" href="{{ URL::to('property/others/' . $value->id . '/edit') }}">{{trans('item.edit')}}</a>
                                                    ...
                                                    @endif
                                                        <div class="btn-group">
                                                            ...
                                                            <div class="dropdown-menu">
                                                                ...
                                                                <a class="dropdown-item" href="{{ route('sale_property.sale', ['property'=>$value]) }}"><i class="fa fa-shopping-cart"></i>{{trans('បន្ថែមការបង់រំលស់ & កម្ចី')}}</a>
                                                                 @if($value->status==1)
                                                            ...
                                                            @endif
                                                                ...
                                                                <a class="dropdown-item" href="{{ URL::to('property/others/' . $value->id . '/duplicate') }}"><i class="fa fa-plus"></i>{{trans('item.duplicate_copy')}}</a>
                                                                @endif
