    ...
    <main class="app-content">
        <div class="app-title">
            <ul class="app-breadcrumb breadcrumb side">
                ...
                <li class="breadcrumb-item active"><a href="#">{{ __('item.add_others') }}</a></li>
            </ul>
        </div>
                            ...
                            <div class="panel-body">
                                ...
                                <div class="row">
                                   <div class="col-md-6">
                                       <div class="form-group">
                                            {!! Form::label('model', trans('ក្រុមហ៊ុន ឬ អ្នកផ្គត់ផ្គង់'))."<span class='star'> *</span>" !!}
                                            {!! Form::text('model', Input::old('model'), array('class' => 'form-control', 'required')) !!}
                                        </div>
                                   </div> 
                                   <div class="col-md-6"> 
                                       <div class="input-group">
                                            {!! Form::label('item.property_name', trans('item.property_name'), array('style'=>'width:100%;')) !!}
                                ...
                                <div class="col-md-6"> 
                                    ...
                                    <div class="col-md-6"> 
                                       <div class="input-group">
                                            ...
                                            {!! Form::text('price', null, array('class' => 'form-control','require','oninput'=>"this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');")) !!}
                                            <div class="input-group-append">
                                ...
                                <div class="row">
                                   ...
                                   <div class="input-group">
                                            ...
                                            {!! Form::text('vehicle_date', null, array('class' => 'form-control','oninput'=>"this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');")) !!}
