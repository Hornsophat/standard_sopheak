	...
	<main class="app-content">
		<div class="app-title">
	        <ul class="app-breadcrumb breadcrumb side">
	          	...
	          	<li class="breadcrumb-item active"><a href="#">{{ __('item.edit_employee') }}</a></li>
	        </ul>
      	</div>
        <div class="col-lg-12">
            @include('flash/message')
          	<div class="panel-body bg-white rounded overflow_hidden p-4">
          		<h3 class="text-dark mb-4">{{ __('item.edit_employee') }}</h3><hr/>

                <form action="{{ route('updateEmployee', $employee->id) }}" method="POST" class="row form-horizontal" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <!-- First name -->
                    <div class="col-lg-6 form-group d-lg-flex align-items-center{{ $errors->has('first_name') ? ' has-error' : '' }}">
                        ...
                        <div class="col-lg-9 p-0">
                            <input type="text" name="first_name" class="form-control" value="{{old('first_name')?old('first_name'): $employee->first_name}}" required autofocus>
                    ...
                    <div class="col-lg-6 form-group d-lg-flex align-items-center{{ $errors->has('last_name') ? ' has-error' : '' }}">
                        ...
                        <div class="col-lg-9 p-0">
                            <input type="text" name="last_name" class="form-control" value="{{old('last_name')?old('last_name'):$employee->last_name}}" required>
                    ...
                    <div class="col-lg-6 form-group d-lg-flex align-items-center{{ $errors->has('id_card') ? ' has-error' : '' }}">
                        ...
                        <div class="col-lg-9 p-0">
                            <input type="text" name="id_card" class="form-control" value="{{old('id_card')?old('id_card'):$employee->id_card}}" required>
                    ...
                    <div class="col-lg-6 form-group d-lg-flex align-items-center{{ $errors->has('salary') ? ' has-error' : '' }}">
                        ...
                        <div class="col-lg-9 p-0">
                            <input type="text" name="salary" class="form-control" value="{{old('salary')?old('salary'):$employee->salary}}">
                    ...
                    <div class="col-lg-6 form-group d-lg-flex align-items-center{{ $errors->has('position') ? ' has-error' : '' }}">
                        ...
                        <div class="col-lg-9 p-0">
                            <div class="input-group mb-3">
                                {{ Form::select('position', $position, $employee->position_id ?? '', ['class' => 'form-control', 'id' => 'select-position', 'required'] ) }}
                    ...
                    <div class="col-lg-6 form-group d-lg-flex align-items-center{{ $errors->has('department') ? ' has-error' : '' }}">
                        ...
                        <div class="col-lg-9 p-0">
                            <div class="input-group mb-3">
                                {{ Form::select('department', $department, $employee->department_id ?? '', ['class' => 'form-control', 'id' => 'select-department', 'required'] ) }}
                              <div class="input-group-prepend">
                    ...
                    <div class="col-lg-6 form-group d-lg-flex align-items-center{{ $errors->has('age') ? ' has-error' : '' }}">
                        ...
                        <div class="col-lg-9 p-0">
                            <input type="number" name="age" class="form-control" value="{{old('age')?old('age'):$employee->age}}" min="0" max="100">
                            @if ($errors->has('age'))
                                <span class="help-block text-danger">
                    ...
                    <div class="col-lg-6 form-group d-lg-flex align-items-center{{ $errors->has('sex') ? ' has-error' : '' }}">
                        ...
                        <div class="col-lg-9 p-0">
                            ...
                            <option value="1" {{ old("sex") ==1? "selected":($employee->sex==1?"selected":"") }}>{{ __('item.male') }}</option>
                            <option value="2" {{ old("sex") ==2? "selected":($employee->sex==2?"selected":"") }}>{{ __('item.female') }}</option>
                        </select>
                            @if ($errors->has('sex'))
                                <span class="help-block text-danger">
                        ...
                        <div class="col-lg-9 p-0">
                            <select name="country" class="form-control" required>
                                ...
                                @foreach($country as $key => $value)
                                    <option value="{{ $value->id }}" {{old("country") == $value->id?"selected":($employee->country_id == $value->id ?"selected":"")}}>{{ $value->name }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-lg-6 form-group d-lg-flex align-items-center{{ $errors->has('nationality') ? ' has-error' : '' }}">
                        ...
                        <div class="col-lg-9 p-0">
                            <input type="text" name="nationality" class="form-control" value="{{old('nationality')?old('nationality'):$employee->nationality}}">
                    ...
                    <div class="col-lg-6 form-group d-lg-flex align-items-center{{ $errors->has('sale_type') ? ' has-error' : '' }}">
                        ...
                        <div class="col-lg-8 p-0">
                            <div class="input-group mb-3">
                                {{ Form::select('sale_type', $sale_type, $employee->sale_type, ['class' => 'form-control select-sale-type', 'required', 'id' => 'sale_type', 'disabled'] ) }}
                              <div class="input-group-prepend">
                    ...
                    <div class="col-lg-6 form-group d-lg-flex align-items-center{{ $errors->has('identity') ? ' has-error' : '' }}">
                        ...
                        <div class="col-lg-9 p-0">
                            <input type="text" name="identity" class="form-control" value="{{old('identity')?old('identity'):$employee->identity}}" required>
                    ...
                    {{-- <div class="col-lg-6 form-group d-lg-flex align-items-center{{ $errors->has('pob') ? ' has-error' : '' }}">
                        ...
                        <div class="col-lg-9 p-0">
                            <textarea name="pob" class="form-control">{{ old("pob")?old("pob"):$employee->pob }}</textarea>
                            @if ($errors->has('pob'))
                                <span class="help-block text-danger">
                        ...
                        <div class="col-lg-9 p-0">
                            <select name="pob_province" class="form-control" id="pob_province">
                                ...
                                @foreach($provinces as $key => $value)
                                    <option value="{{ $value->province_id }}" @if($value->province_id==$employee->pob_province) selected @endif>{{ $value->province_kh_name }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-lg-6 form-group d-lg-flex align-items-center{{ $errors->has('pob_district') ? ' has-error' : '' }}">
                        ...
                        <div class="col-lg-9 p-0">
                            <select name="pob_district" class="form-control" id="pob_district" @if(!$employee->pob_district) disabled @endif>
                                <option value=>-- {{ __('item.select') }} --</option>
                                @foreach($pob_districts as $key => $value)
                                    <option value="{{ $value->dis_id }}" @if($value->dis_id==$employee->pob_district) selected @endif>{{ $value->district_namekh }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-lg-6 form-group d-lg-flex align-items-center{{ $errors->has('pob_commune') ? ' has-error' : '' }}">
                        ...
                        <div class="col-lg-9 p-0">
                            <select name="pob_commune" class="form-control" id="pob_commune" @if(!$employee->pob_commune) disabled @endif>
                                <option value=>-- {{ __('item.select') }} --</option>
                                @foreach($pob_communes as $key => $value)
                                    <option value="{{ $value->com_id }}" @if($value->com_id==$employee->pob_commune) selected @endif>{{ $value->commune_namekh }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-lg-6 form-group d-lg-flex align-items-center{{ $errors->has('pob_village') ? ' has-error' : '' }}">
                        ...
                        <div class="col-lg-9 p-0">
                            <select name="pob_village" class="form-control" id="pob_village" @if(!$employee->pob_village) disabled @endif>
                                <option value=>-- {{ __('item.select') }} --</option>
                                @foreach($pob_villages as $key => $value)
                                    <option value="{{ $value->vill_id }}" @if($value->vill_id==$employee->pob_village) selected @endif>{{ $value->village_namekh }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-lg-6 form-group d-lg-flex align-items-center{{ $errors->has('phone1') ? ' has-error' : '' }}">
                        ...
                        <div class="col-lg-9 p-0">
                            <input type="text" name="phone1" class="form-control" value="{{old('phone1')?old('phone1'):$employee->phone1}}" required>
                    ...
                    <div class="col-lg-6 form-group d-lg-flex align-items-center{{ $errors->has('phone2') ? ' has-error' : '' }}">
                        ...
                        <div class="col-lg-9 p-0">
                            <input type="text" name="phone2" class="form-control" value="{{old('phone2')?old('phone2'):$employee->phone2}}">
                    ...
                    <div class="col-lg-6 form-group d-lg-flex align-items-center{{ $errors->has('email') ? ' has-error' : '' }}">
                        ...
                        <div class="col-lg-9 p-0">
                            <input type="email" name="email" class="form-control" value="{{old('email')?old('email'):$employee->email}}" required>
                            @if ($errors->has('email'))
                                <span class="help-block text-danger">
                    ...
                    <div class="col-lg-6 form-group d-lg-flex align-items-center{{ $errors->has('fax') ? ' has-error' : '' }}">
                        ...
                        <div class="col-lg-9 p-0">
                            <input type="text" name="fax" class="form-control" value="{{old('fax')?old('fax'):$employee->fax}}">
                            @if ($errors->has('fax'))
                                <span class="help-block text-danger">
                    ...
                    <div class="col-lg-6 form-group d-lg-flex align-items-center{{ $errors->has('province') ? ' has-error' : '' }}">
                        ...
                        <div class="col-lg-9 p-0">
                            <select name="province" class="form-control" id="province" required>
                                <option value=>-- {{ __('item.select') }} --</option>
                                @foreach($provinces as $key => $value)
                                    <option value="{{ $value->province_id }}" @if($value->province_id==$employee->province) selected @endif>{{ $value->province_kh_name }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-lg-6 form-group d-lg-flex align-items-center{{ $errors->has('district') ? ' has-error' : '' }}">
                        ...
                        <div class="col-lg-9 p-0">
                            <select name="district" class="form-control" id="district" required @if(!$employee->district) disabled @endif>
                                <option value=>-- {{ __('item.select') }} --</option>
                                @foreach($districts as $key => $value)
                                    <option value="{{ $value->dis_id }}" @if($value->dis_id==$employee->district) selected @endif>{{ $value->district_namekh }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-lg-6 form-group d-lg-flex align-items-center{{ $errors->has('commune') ? ' has-error' : '' }}">
                        ...
                        <div class="col-lg-9 p-0">
                            <select name="commune" class="form-control" id="commune" required @if(!$employee->commune) disabled @endif>
                                <option value=>-- {{ __('item.select') }} --</option>
                                @foreach($communes as $key => $value)
                                    <option value="{{ $value->com_id }}" @if($value->com_id==$employee->commune) selected @endif>{{ $value->commune_namekh }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-lg-6 form-group d-lg-flex align-items-center{{ $errors->has('village') ? ' has-error' : '' }}">
                        ...
                        <div class="col-lg-9 p-0">
                            <select name="village" class="form-control" id="village" required @if(!$employee->village) disabled @endif>
                                <option value=>-- {{ __('item.select') }} --</option>
                                @foreach($villages as $key => $value)
                                    <option value="{{ $value->vill_id }}" @if($value->vill_id==$employee->village) selected @endif>{{ $value->village_namekh }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-lg-6 form-group d-lg-flex align-items-center{{ $errors->has('profile') ? ' has-error' : '' }}">
                        <label for="profile" class="control-label col-lg-3 p-0">{{ __('item.profile') }} : </label>
                        <div class="col-lg-9 p-0">
