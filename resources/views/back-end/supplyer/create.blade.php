    ...
    <main class="app-content">
        <div class="app-title">
            <ul class="app-breadcrumb breadcrumb side">
                ...
                <li class="breadcrumb-item" ><a href="{{ route('supplyers') }}">{{ __('item.supplier') }}</a></li>
                <li class="breadcrumb-item active"><a href="#">{{ __('item.add_supplier') }}</a></li>
            </ul>
        </div>
        <div class="col-lg-12">
            @include('flash/message')
            <div class="panel-body bg-white rounded overflow_hidden p-4">
                <h3>{{ __('item.add_supplier') }}</h3>
                <hr/>
                <form action="{{ route('supplyer.store') }}" method="POST" class="row form-horizontal" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    ...
                    <!-- Firstname -->
                    <div class="col-lg-6 form-group d-lg-flex align-items-center{{ $errors->has('firstname') ? ' has-error' : '' }}">
                    ...
                    <!-- Lastname -->
                    <div class="col-lg-6 form-group d-lg-flex align-items-center{{ $errors->has('lastname') ? ' has-error' : '' }}">
