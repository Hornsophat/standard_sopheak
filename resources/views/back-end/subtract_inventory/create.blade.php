...
@section('title', 'Add Subtract Inventory')
@section('style')
...
<main class="app-content">
	<div class="app-title">
		<ul class="app-breadcrumb breadcrumb side">
			...
			<li class="breadcrumb-item active"><a href="#">{{ __('item.add_subtract_inventory') }}</a></li>
		</ul>
	</div>
				...
				<div class="col-md-12">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							{!! Form::open(array(route('subtract_inventory.create'), 'files' => true, 'method'=>'post')) !!}
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
									{!! Form::label('project', trans('item.project'))."<span class='star'> *</span>" !!}
									{!! Form::select('project',$projects , Input::old('project'), array('class' => 'form-control select2-option-picker cal-total-cost', 'id' => 'project')) !!}
							...
							<div class="row">
								...
								<div class="col-md-6">
									...
									{!! Form::select('status',$statuses , Input::old('status'), array('class' => 'form-control cal-total-cost', 'id' => 'status')) !!}
