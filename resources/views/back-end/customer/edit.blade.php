	...
	<main class="app-content">
		<div class="app-title">
	        <ul class="app-breadcrumb breadcrumb side">
	          	...
	          	<li class="breadcrumb-item active"><a href="#">{{ __('item.edit_customer') }}</a></li>
	        </ul>
      	</div>
        <div class="col-lg-12">
            @include('flash/message')
          	<div class="panel-body bg-white rounded overflow_hidden p-4">
                <h3>{{ __('item.edit_customer') }}</h3>
                <hr/>
                <form action="{{ route('updateCustomer', $customer->id) }}" method="POST" class="row form-horizontal" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    ...
                    <div class="col-lg-6 form-group d-lg-flex align-items-center{{ $errors->has('first_name_en') ? ' has-error' : '' }}">
                        ...
                        <div class="col-lg-9 p-0">
                            <input type="text" name="first_name_en" class="form-control" value="{{old('first_name_en')?old('first_name_en'):$customer->first_name_en}}" required autofocus>
                    ...
                    <div class="col-lg-6 form-group d-lg-flex align-items-center{{ $errors->has('last_name_en') ? ' has-error' : '' }}">
                        <label for="last_name_en" class="control-label col-lg-3 p-0">{{ __('item.last_name') }} (En)<span class="required">*</span></label>
                        <div class="col-lg-9 p-0">
                            <input type="text" name="last_name_en" class="form-control" value="{{old('last_name_en')?old('last_name_en'):$customer->last_name_en}}" required>
                    ...
                    <div class="col-lg-6 form-group d-lg-flex align-items-center{{ $errors->has('first_name') ? ' has-error' : '' }}">
                        ...
                        <div class="col-lg-9 p-0">
                            <input type="text" name="first_name" class="form-control" value="{{old('first_name')?old('first_name'):$customer->first_name}}" required autofocus>
                    ...
                    <div class="col-lg-6 form-group d-lg-flex align-items-center{{ $errors->has('last_name') ? ' has-error' : '' }}">
                        ...
                        <div class="col-lg-9 p-0">
                            <input type="text" name="last_name" class="form-control" value="{{old('last_name')?old('last_name'):$customer->last_name}}" required>
                    ...
                    <div class="col-lg-6 form-group d-lg-flex align-items-center{{ $errors->has('age') ? ' has-error' : '' }}">
                        ...
                        <div class="col-lg-9 p-0">
                            <input type="number" name="age" class="form-control" value="{{old('age')?old('age'):$customer->age}}" min="0" max="100">
                            @if ($errors->has('age'))
                                <span class="help-block text-danger">
                    ...
                    <div class="col-lg-6 form-group d-lg-flex align-items-center{{ $errors->has('sex') ? ' has-error' : '' }}">
                        ...
                        <div class="col-lg-9 p-0">
                            ...
                            <option value="1" {{ old("sex") == 1? "selected":($customer->sex ==1?"selected":"") }}>{{ __('item.male') }}</option>
                            <option value="2" {{ old("sex") == 2? "selected":($customer->sex ==2?"selected":"") }}>{{ __('item.female') }}</option>
                        </select>
                            @if ($errors->has('sex'))
                                <span class="help-block text-danger">
                        ...
                        <div class="col-lg-9 p-0">
                            <select name="country" class="form-control" id="country" required>
                                ...
                                @foreach($countries as $key=>$value)
                                    <option value="{{ $value->id }}" {{ old("country") == $value->id? "selected":($customer->country == $value->id ?"selected":"") }}>{{ $value->name }}</option>
                                    @endforeach
                    ...
                    <div class="col-lg-6 form-group d-lg-flex align-items-center{{ $errors->has('nationality') ? ' has-error' : '' }}">
                        ...
                        <div class="col-lg-9 p-0">
                            <input type="text" name="nationality" class="form-control" value="{{old('nationality')?old('nationality'):$customer->nationality}}" required>
                    ...
                    <div class="col-lg-6 form-group d-lg-flex align-items-center{{ $errors->has('dob') ? ' has-error' : '' }}">
                        ...
                        <div class="col-lg-9 p-0">
                            <input type="date" name="dob" class="form-control dateISO"  value="{{old("dob")?old("dob"):$customer->dob}}">
                            @if ($errors->has('dob'))
                                <span class="help-block text-danger">
                    ...
                    <div class="col-lg-6 form-group d-lg-flex align-items-center{{ $errors->has('identity') ? ' has-error' : '' }}">
                        ...
                        <div class="col-lg-9 p-0">
                            <input type="text" name="identity" class="form-control" value="{{old('identity')?old('identity'):$customer->identity}}" required>
                     ...
                     <div class="col-lg-6 form-group d-lg-flex align-items-center{{ $errors->has('identity_set_date') ? ' has-error' : '' }}">
                        ...
                        <div class="col-lg-9 p-0">
                            <input type="date" name="identity_set_date" class="form-control dateISO"  value="{{old("identity_set_date")?old("identity_set_date"):$customer->identity_set_date}}" required>
                        ...
                        <div class="col-lg-9 p-0">
                            <select name="pob_province" class="form-control" id="pob_province">
                                ...
                                @foreach($provinces as $key => $value)
                                    <option value="{{ $value->province_id }}" @if($value->province_id==$customer->pob_province) selected @endif>{{ $value->province_kh_name }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-lg-6 form-group d-lg-flex align-items-center{{ $errors->has('pob_district') ? ' has-error' : '' }}">
                        ...
                        <div class="col-lg-9 p-0">
                            <select name="pob_district" class="form-control" id="pob_district" @if(!$customer->pob_district) disabled @endif>
                                <option value=>-- {{ __('item.select') }} --</option>
                                @foreach($pob_districts as $key => $value)
                                    <option value="{{ $value->dis_id }}" @if($value->dis_id==$customer->pob_district) selected @endif>{{ $value->district_namekh }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-lg-6 form-group d-lg-flex align-items-center{{ $errors->has('pob_commune') ? ' has-error' : '' }}">
                        ...
                        <div class="col-lg-9 p-0">
                            <select name="pob_commune" class="form-control" id="pob_commune" @if(!$customer->pob_commune) disabled @endif>
                                <option value=>-- {{ __('item.select') }} --</option>
                                @foreach($pob_communes as $key => $value)
                                    <option value="{{ $value->com_id }}" @if($value->com_id==$customer->pob_commune) selected @endif>{{ $value->commune_namekh }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-lg-6 form-group d-lg-flex align-items-center{{ $errors->has('pob_village') ? ' has-error' : '' }}">
                        ...
                        <div class="col-lg-9 p-0">
                            <select name="pob_village" class="form-control" id="pob_village" @if(!$customer->pob_village) disabled @endif>
                                <option value=>-- {{ __('item.select') }} --</option>
                                @foreach($pob_villages as $key => $value)
                                    <option value="{{ $value->vill_id }}" @if($value->vill_id==$customer->pob_village) selected @endif>{{ $value->village_namekh }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-lg-6 form-group d-lg-flex align-items-center{{ $errors->has('phone1') ? ' has-error' : '' }}">
                        ...
                        <div class="col-lg-9 p-0">
                            <input type="text" name="phone1" class="form-control" value="{{old('phone1')?old('phone1'):$customer->phone1}}" required>
                    ...
                    <div class="col-lg-6 form-group d-lg-flex align-items-center{{ $errors->has('phone2') ? ' has-error' : '' }}">
                        ...
                        <div class="col-lg-9 p-0">
                            <input type="text" name="phone2" class="form-control" value="{{old('phone2')?old('phone2'):$customer->phone2}}">
                    ...
                    <div class="col-lg-6 form-group d-lg-flex align-items-center{{ $errors->has('fax') ? ' has-error' : '' }}">
                        <label for="fax" class="control-label col-lg-3 p-0">{{ __('តួនាទី') }} : </label>
                        <div class="col-lg-9 p-0">
                            <input type="text" name="fax" class="form-control" value="{{old('fax')?old('fax'):$customer->fax}}">
                            @if ($errors->has('fax'))
                                <span class="help-block text-danger">
                    ...
                    <div class="col-lg-6 form-group d-lg-flex align-items-center{{ $errors->has('province') ? ' has-error' : '' }}">
                        ...
                        <div class="col-lg-9 p-0">
                            <select name="province" class="form-control" id="province" required>
                                <option value=>-- {{ __('item.select') }} --</option>
                                @foreach($provinces as $key => $value)
                                    <option value="{{ $value->province_id }}" @if($value->province_id==$customer->province) selected @endif>{{ $value->province_kh_name }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-lg-6 form-group d-lg-flex align-items-center{{ $errors->has('district') ? ' has-error' : '' }}">
                        ...
                        <div class="col-lg-9 p-0">
                            <select name="district" class="form-control" id="district" required @if(!$customer->district) disabled @endif>
                                <option value=>-- {{ __('item.select') }} --</option>
                                @foreach($districts as $key => $value)
                                    <option value="{{ $value->dis_id }}" @if($value->dis_id==$customer->district) selected @endif>{{ $value->district_namekh }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-lg-6 form-group d-lg-flex align-items-center{{ $errors->has('commune') ? ' has-error' : '' }}">
                        ...
                        <div class="col-lg-9 p-0">
                            <select name="commune" class="form-control" id="commune" required @if(!$customer->commune) disabled @endif>
                                <option value=>-- {{ __('item.select') }} --</option>
                                @foreach($communes as $key => $value)
                                    <option value="{{ $value->com_id }}" @if($value->com_id==$customer->commune) selected @endif>{{ $value->commune_namekh }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-lg-6 form-group d-lg-flex align-items-center{{ $errors->has('village') ? ' has-error' : '' }}">
                        ...
                        <div class="col-lg-9 p-0">
                            <select name="village" class="form-control" id="village" required @if(!$customer->village) disabled @endif>
                                <option value=>-- {{ __('item.select') }} --</option>
                                @foreach($villages as $key => $value)
                                    <option value="{{ $value->vill_id }}" @if($value->vill_id==$customer->village) selected @endif>{{ $value->village_namekh }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-lg-6 form-group d-lg-flex align-items-center{{ $errors->has('house_number') ? ' has-error' : '' }}">
                        <label for="house_number" class="control-label col-lg-3 p-0">House Numbe</span></label>
                        <div class="col-lg-9 p-0">
                            <input name="house_number" type="text" class="form-control" value="{{old('house_number')?old('house_number'):$customer->house_number}}">
