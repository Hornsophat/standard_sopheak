...
@endphp
 	<div class="row">
        	<div class="col-md-12">
       		...
       		<div class="tile">
       			<div class="form-group mb-0" style="overflow: hidden;">
       				<button class="btn btn-lg btn-success btnPrint pull-right mr-1" onclick="printFunc();"><i class="fa fa-print" aria-hidden="true"></i>{{ __('item.print_this_page') }}</button>
       			</div> 
         		<div class="tile-body">
						<style type="text/css">
							.table-responsive{
							...
							<div class="card">
								<div class="content" style="margin-top: 0px; padding-top: 0;">
				                	...
				                	<tbody>
				                				...
				                				<td style="margin-top: 0; padding-top: 0;">
				                					<table width="100%">
				                						<tr>
				                							...
				                							<td width="50%" style="margin-top: 0; padding-top: 0; font-size: 18px">ព្រះរាជាណាចក្រកម្ពុជា</td>
				                						</tr>
				                						<tr>
				                							<td width="50%"></td>
				                							<td width="50%" style="font-size: 18px">ជាតិ សាសនា ព្រះមហាក្សត្រ</td>
				                						</tr>
				                					</table>
				                				</td>
				                			</tr>
											...
											<tr><td><p></p></td></tr>
											<tr>
												<td style="text-decoration: none;font-size: 13pt;">កិច្ចសន្យាលក់ ទិញដីឡូត៍</td>
											</tr>
					                	<tr>
					                		<td>
					                	...
					                	<tr>
					                		<td>
					                			<p class="p" style="text-align: justify;">&emsp;&emsp;&emsp;ប្រាក់នៅសល់ចំនួន{{ AppHelper::khMultipleNumber($b_amount*1) }}({{ AppHelper::khNumberWord($b_amount*1) }}) ដុល្លារអាមេរិកគត់ភាគី “ខ” យល់ព្រមបង់រំលស់ ប្រាក់ដែលនៅសល់ចំនួន{{ AppHelper::khMultipleNumber($amount_pay_permonth) }} ({{ AppHelper::khNumberWord($amount_pay_permonth) }}) ដុល្លារក្នុងមួយខែរយៈពេល{{ AppHelper::khMultipleNumber(count($first_step_sche_payments)) }}ខែ ដោយគ្មានការប្រាក់ ជាមួយក្រុមហ៊ុនគិតចាប់ពីថ្ងៃទី{{ AppHelper::khMultipleNumber(date('d', strtotime($first_step_sche_payments[0]->payment_date))) }} ខែ{{ AppHelper::khMonth(date('m', strtotime($first_step_sche_payments[0]->payment_date))) }} ឆ្នាំ{{ AppHelper::khMultipleNumber(date('Y', strtotime($first_step_sche_payments[0]->payment_date))) }} តាមតារាងឧបសម្ព័ន្ធដោយឡែក។ ចំពោះទឹកប្រាក់ដែលនៅសល់ក្រោយការបង់ដោយគ្មានការប្រាក់រយៈពេល{{ AppHelper::khMultipleNumber(count($first_step_sche_payments)) }}ខែនេះអតិថិជនត្រូវបង់រំលស់បន្តជាមួយក្រុមហ៊ុនឲ្យអស់ក្នុងរយៈពេល១២ខែទៀតក្នុងអត្រាការប្រាក់ប្រចាំខែ១.២%តាមតារាងឧបសម្ព័ន្ធដោយឡែក។</p>
					                		</td>
					                	</tr>
					                	<tr>
					                		<td>
					                	...
					                	<tr>
					                		<td>
					                			<p class="p" style="text-align: justify;">&emsp;&emsp;&emsp;ក្នុងករណីភាគី “ខ” បង់ប្រាក់យឺតយ៉ាវ ភាគី “ខ” ត្រូវបង់ប្រាក់ពិន័យជូនភាគី “ក” ដូចខាងក្រោមៈ បង់យឺតចាប់ពី៣ថ្ងៃ ទៅ ១០ថ្ងៃពិន័យ ៥%  បង់យឺតចាប់ពី១១ទៅ៣០ថ្ងៃពិន័យ១០% និងយឺតពី ៣១ថ្ងៃ ទៅ ៩០ថ្ងៃ ពិន័យ ២០% នៃទឹក ប្រាក់ត្រូវបង់។ បើបង់យឺតលើសកំណត់ ៩០ថ្ងៃ ភាគី “ខ” បានយល់ព្រមឲ្យភាគី “ក” ដកហូតយកដីឡូតិ៍មកវិញដោយពុំមាន ប្រគល់សំណងទៅភាគី “ខ” វិញឡើយ ហើយប្រាក់ដែលបាន បង់រួចត្រូវទុកជាអសាបង់ ។</p>
					                		</td>
					                	</tr>
					                	<tr>
					                		<td align="left">
					                			ប្រការ៣ - លក្ខខណ្ឌការប្រគល់ដី
					                		</td>
					                	</tr>
					                	<tr>
					                		<td>
					                			<p class="p" style="text-align: justify;">&emsp;&emsp;&emsp;នៅពេលដែលភាគី “ខ” បានបង់ប្រាក់ថ្លៃទិញដីគ្រប់ចំនួន នោះទើបភាគី “ក” ប្រគល់វិញ្ញាបនប័ត្រ សម្គាល់ម្ចាស់អចលនវត្ថុ (ប្លង់រឹងបំបែកក្បាលដី) ជូនទៅភាគី “ខ” ។ រាល់ការចំណាយកាត់ឈ្មោះ និងបង់ពន្ធជូនរដ្ឋជាបន្ទុករបស់ភាគី“ខ” ។   ករណីភាគី”ខ” ផ្តល់ឱ្យភាគី”ក”     ជាអ្នកផ្ទេរកម្មសិទ្ធ (ប្លង់រឹងបំបែកក្បាលដី) ជូនភាគី”ខ” ត្រូវចំណាយបន្ថែមចំនួន១០០០ដុល្លារក្នុងដីមួយឡូត៍ ប៉ុន្តែភាគី“ខ” មានសិទ្ធរស់នៅ ឬសាងសង់លើដីឡូត៍នោះចាប់ពីថ្ងៃចុះកិច្ចសន្យារួច។</p>
					                		</td>
					                	</tr>
					                	<tr>
					                		<td align="left">
					                	...
					                	<tr>
					                		<td>
					                			{{-- <p class="p" style="text-align: justify;">&emsp;&emsp;&emsp;ភាគី“ក” យល់ព្រមបំបែកដីចេញពីប្លង់លេខ........................មានទំហំ............ម៉ែត្រការ៉េ  និងទំហំ ដីឡូតិ៍............ម៉ែត្រការ៉េ  មានព្រំប្រទល់ ៖ </p> --}}
					                			<p class="p" style="text-align: justify;">&emsp;&emsp;&emsp;ទំហំដីឡូតិ៍{{ ($sale->width*$sale->length)?(AppHelper::khMultipleNumber($sale->width*$sale->length)):'..............' }}ម៉ែត្រការ៉េ  មានព្រំប្រទល់ ៖ </p>
					                		</td>
					                	</tr>
					                	<tr>
					                		<td>
					                	...
					                	<tr>
					                		<td>
					                			<p class="p" style="text-align: justify;">ដីឡូតិ៍លេខ{{ $sale->item_number }} @if($sale->address_street) ផ្លូវ{{ $sale->address_street }} @endif ភូមិ{{ $sale->village_name }} សង្កាត់{{ $sale->commune_name }} ខណ្ឌ{{ $sale->district_name }} រាជធានីភ្នំពេញ។</p>
					                		</td>
					                	</tr>
					                	<tr>
					                		<td align="left">
					                	...
					                	<tr>
					                		<td>
					                			<p class="p" style="text-align: justify;">&emsp;&emsp;&emsp;កិច្ចសន្យានេះរួមមាន២ទំព័រ ត្រូវជា៧ប្រការ។ កិច្ចសន្យានេះត្រូវបានរៀបចំធ្វើជាពីរច្បាប់ដើមជា ភាសាខ្មែរ មួយច្បាប់កាន់កាប់ដោយភាគី ”ក” និងមួយច្បាប់ទៀតកាន់កាប់ដោយភាគី ”ខ”។</p>
					                		</td>
					                	</tr>
					                	<tr>
					                		<td>
