	...
	<main class="app-content">
		<div class="app-title">
	        <ul class="app-breadcrumb breadcrumb side">
	          	...
	          	<li class="breadcrumb-item active"><a href="#">{{ __('item.purchase_report') }}</a></li>
	        </ul>
      	</div>
		<div class="row">
        	<div class="col-md-12">
				@include('flash/message')
          		<div class="tile">
            		<div class="tile-body bg-white rounded overflow_hidden p-4">
						<div class="rows">
							<form action="{{ url('purchase_report') }}" method="get" class="form-inline" id="frmSubmit">
						...
						<table class="table table-hover table-bordered">
			                <thead>
			                  	<tr>
				                    ...
				                    <th class="text-center">{{ __('item.total_cost') }}</th>
	                		...
	                		<tbody>
				                ...
				                @endforeach
				                <tr>
				                	<th colspan="4" style="text-align: right;">{{ __('item.total') }}</th>
