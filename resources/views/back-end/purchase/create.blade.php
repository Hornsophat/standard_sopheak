...
<main class="app-content">
	<div class="app-title">
		<ul class="app-breadcrumb breadcrumb side">
			...
			<li class="breadcrumb-item active"><a href="#">{{ __('item.add_purchase') }}</a></li>
		</ul>
	</div>
			...
			<div class="row">
				<div class="col-md-12">
					<div class="panel panel-default">
						<h3>{{ __('item.add_purchase') }}</h3><hr/>
						<div class="panel-body">
							@if (Session::has('message'))
							<div class="alert alert-info">{{ Session::get('message') }}</div>
							@endif

							{!! Form::open(array(route('purchase.create'), 'files' => true, 'method'=>'post')) !!}
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
									{!! Form::label('project', trans('item.project'))."<span class='star'> *</span>" !!}
									{!! Form::select('project',$projects , Input::old('project'), array('class' => 'form-control select2-option-picker cal-total-cost', 'id' => 'numproject')) !!}
							...
							<div class="row">
								<div class="col-md-6">
									...
									{!! Form::select('supplyer',$supplyers , Input::old('supplyer'), array('class' => 'form-control select2-option-picker cal-total-cost', 'id' => 'numsupplyer')) !!}
								...
								<div class="col-md-6">
									<div class="form-group">
									{!! Form::label('qty', __('item.quantity'))."<span class='star'> *</span>" !!}
								...
								<div class="col-md-6">
									<div class="form-group">
									{!! Form::label('unit_cost', __('item.unit_cost'))."<span class='star'> *</span>" !!}
								...
								<div class="col-md-6">
									<div class="form-group">
									{!! Form::label('total_cost', __('item.total_cost'))."<span class='star'> *</span>" !!}
								...
								<div class="col-md-6 mb-3"> 
                                   <div class="input-group">
                                        ...
                                        {!! Form::text('discount', 0, array('style' => 'width:70%;','oninput'=>"this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');")) !!}
                               ...
                               <div class="col-md-12"></div>
								<div class="col-md-6">
									...
									{!! Form::select('status',$statuses , Input::old('status'), array('class' => 'form-control', 'id' => 'status')) !!}
