                ...
                <div class="table-responsive">
                    <div class="content-printer clearfix" id="table_print">
                        <div class="header">
                            ...
                            <div class="title">
                                <p style="margin-bottom: 0; font-family: Khmer OS Muol Light;">ក្រុមហ៊ុន​ ស៊ី​ យូ​ អេស​ គ្រុប​(ខេម​បូឌា)</p>
                                <p style="display:inline-block;border-bottom:2px solid black;padding-bottom:1px;">CUS GROUP (CAMBODIA) CO,.LTD</p>
                            </div>
                            <div class="title">
                                <p style="margin-bottom: 0;"><span style="font-family: Khmer OS Muol Light;">បង្កាន់ដៃទទួលប្រាក់</span><span style="margin-left: 25px; color:red">N<sup>o</sup> {{ $payment_transaction->reference }}</span></p>
                            </div>
                        </div>
                        <div class="body">
