                    ...
                    <div class="content-printer clearfix" id="table_print" style="background: #a59b9b1f">
                        ...
                        <div class="body">
                            ...
                            <p class="text-justify f-kh" style="text-align: justify-all;">
                                ...
                                <br>
                                <span class="f-kh">ឈ្មោះទំនិញ</span>
                                <span class="horizontal_dotted_lines" style="min-width: 100px">&nbsp;{{$property->property_name}}</span>
                                <span class="f-kh">ម៉ាក់ទំនិញ(ប្រេន ឬ ម៉ូឌែល)</span>
                                <span class="horizontal_dotted_lines" style="min-width: 100px">&nbsp;{{$property->property_no}}</span>
                                <span class="f-kh">ពណ័</span>
                                <span class="horizontal_dotted_lines" style="min-width: 100px">&nbsp;{{$property->vehicle_color}}</span>
                                <!-- <span class="f-kh">ផ្លូវលេខៈ</span>
                                <span class="horizontal_dotted_lines" style="min-width: 70px">&nbsp;{{$property->address_number}}</span> -->
                                <!-- <span class="f-kh">ប្រភេទនៃការលក់</span>
                                <span class="horizontal_dotted_lines" style="min-width: 100px">&nbsp;{{ $project->property_name }} </span> -->
                                <br>
                                <span class="f-kh">តម្លៃទំនិញ:​</span>
                                 <span class="horizontal_dotted_lines" style="min-width: 120px">&nbsp;​${{ number_format($property->property_price,2) }} </span>
                                (
                                <span class="horizontal_dotted_lines" style="min-width: 260px">&nbsp;​{{ AppHelper::khNumberWord($property->property_price) }}ដុល្លារអាមេរិក</span>
                                ) 
                                <br>
                                <span class="f-kh">ទឹកប្រាក់បានបង់(បានកក់ទុក):</span>
