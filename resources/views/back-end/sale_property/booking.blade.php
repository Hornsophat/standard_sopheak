...
@section('title', 'Booking Property')
@section('style')
    ...
    <main class="app-content">
        <div class="app-title">
            <ul class="app-breadcrumb breadcrumb side">
                ...
                <li class="breadcrumb-item active"><a href="#">{{ __('item.booking_property') }}</a></li>
            </ul>
        </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <h3>{{ __('item.booking_property') }}</h3><hr/>
                            ...
                            <div class="panel-body">
                                ...
                                {!! Form::open(array('url' => route('sale_property.booking',['property'=>$property]) , 'method' => 'POST', 'files' => true)) !!}
                                ...
                                <div class="row">
                                   ...
                                   <div class="col-md-6"> 
                                       <div class="input-group">
                                            ...
                                            {!! Form::text('date', null, array('class' => 'form-control date-picker', 'style'=>'cursor:pointer;','autocomplete' => 'off', 'placeholder' => 'dd-mm-yyyy')) !!}
                                   ...
                                   <div class="col-md-6"> 
                                       <div class="form-group">
                                            ...
                                            {!! Form::select('customer', $customers,null, array('class' => 'form-control', 'id' => 'customer')) !!}
                                   ...
                                   <div class="col-md-6"> 
                                       <div class="input-group">
                                            ...
                                            {!! Form::text('date_expire', null, array('class' => 'form-control date-picker', 'style'=>'cursor:pointer;','autocomplete' => 'off', 'placeholder' => 'dd-mm-yyyy')) !!}
                                            <div class="input-group-append">
                                                <span class="input-group-text" ><i class="fa fa-calendar"></i></span>
                                            </div>
                                   ...
                                   <div class="col-md-6"> 
                                       <div class="input-group">
                                            ...
                                            {!! Form::text('deposit', null, array('class' => 'form-control','oninput'=>"this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');")) !!}
                                            <div class="input-group-append">
                                                <span class="input-group-text" >$</span>
                                            </div>
