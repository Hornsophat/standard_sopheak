                ...
                <div class="table-responsive">
                    <div class="content-printer clearfix" id="table_print">
                        <div class="header">
                            ...
                            <div class="title">
                                <p style="margin-bottom: 0; font-family: Khmer OS Muol Light;">បង្កាន់ដៃកក់ប្រាក់</p>
                        ...
                        <div class="body">
                            <table style="width: 100%;">
                                <thead>
                                    <tr>
                                        <td colspan="7" style="text-align: right;​​"><span style="font-family: Khmer OS System;">ថ្ងៃទទួលប្រាក់ : </span><span style="font-family: Khmer OS System;">{{ AppHelper::khMultipleNumber(date('d', strtotime($reservation->date_booked))).'-'.AppHelper::khMonth(date('m', strtotime($reservation->date_booked))).'-'.AppHelper::khMultipleNumber(date('Y', strtotime($reservation->date_booked))) }}</span></td>
                                    </tr>
                                    <tr>
                                        <td colspan="7" style="text-align: right;​​"><span style="font-family: Khmer OS System;">លេខកូដ</span>  N<sup>o</sup> : <span>{{ $payment_transaction->reference }}</span></td>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        <td style="font-family: Khmer OS System;">ឈ្មោះ</td>
                                        <td style="width: 65mm;font-family: Khmer OS System;border:solid 1px grey;">{{ $customer->last_name.' '.$customer->first_name }}</td>
                                        <td width="30mm"></td>
                                        <td style="font-family: Khmer OS System;">ថ្ងៃផុតកំណត់</td>
                                        <td colspan="3" style="font-family: Khmer OS System;border:solid 1px grey">{{ AppHelper::khMultipleNumber(date('d', strtotime($reservation->date_expire))).'-'.AppHelper::khMonth(date('m', strtotime($reservation->date_expire))).'-'.AppHelper::khMultipleNumber(date('Y', strtotime($reservation->date_expire))) }}</td>
                                    </tr>
                                    <tr>
                                        <td style="font-family: Khmer OS System;">ក្បាលដី</td>
                                        <td style="width: 65mm;border:solid 1px grey;">{{ $property->property_no }}</td>
                                        <td width="30mm"></td>
                                        <td style="font-family: Khmer OS System;">គម្រោង</td>
                                        <td colspan="3" style="border:solid 1px grey;font-family: Khmer OS System;">{{ $project->property_name }}</td>
                                    </tr>
                                    <tr>
                                        <td style="font-family: Khmer OS System;">ចំនួនទឹកប្រាក់</td>
                                        <td colspan="4" style="border:solid 1px grey;">${{ number_format($reservation->amount,2) }}</td>
                                    </tr>
                                    <tr>
                                        <td style="font-family: Khmer OS System;">សម្គាល់</td>
                                        <td colspan="4" style="border:solid 1px grey;font-family: Khmer OS System;">{{ $reservation->remark }}</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                        <div class="footer">
                            <div class="row" style="font-family: Khmer OS System;​">
                                <div class="col-sm-4 col-mb-7">
                                    <span>ស្នាមមេដៃគណនេយ្យ</span>
                                </div>
                                <div class="col-sm-4 col-mb-7 text-center">
                                    <span>ស្នាមមេដៃអ្នកប្រគល់</span>
                                </div>
                                <div class="col-sm-4 col-mb-7 text-center">
                                    <span>ស្នាមមេដៃអ្នកទទួល</span>
                                </div>
