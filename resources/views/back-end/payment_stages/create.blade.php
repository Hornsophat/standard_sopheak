...
@section('title', __('item.add_payment_stage'))
@section('style')
    ...
    <main class="app-content">
        <div class="app-title">
            <ul class="app-breadcrumb breadcrumb side">
                ...
                <li class="breadcrumb-item active"><a href="#">{{ __('item.add_payment_stage') }}</a></li>
            </ul>
        </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <h3>{{ __('item.add_payment_stage') }}</h3><hr/>
                            ...
                            <div class="panel-body">
                                ...
                                {!! Form::open(array('url' => route('payment_stage.create') , 'method' => 'POST', 'files' => true)) !!}
                                <div class="row">
                                        ...
                                        <div class="row">
                                           <div class="col-md-12"> 
                                               <div class="input-group">
                                                    ...
                                                    {!! Form::text('amount', null, array('class' => 'form-control','oninput'=>"this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');")) !!}
