...
<main class="app-content">
	<div class="app-title">
		<ul class="app-breadcrumb breadcrumb side">
			...
			<li class="breadcrumb-item"><a href="{{ route('product.categories') }}">{{ __('item.list_categories') }}</a></li>
			<li class="breadcrumb-item active"><a href="#">{{ __('item.edit_category') }}</a></li>
		</ul>
	</div>
			...
			<div class="row">
				<div class="col-md-12">
					<div class="panel panel-default">
						<h3>{{ __('item.edit_category') }}</h3><hr/>
						<div class="panel-body">
							{!! Form::model($category, array('route' => array('product.category.edit', $category->id))) !!}
