...
@section('title',__('item.add_district'))
@section('style')
	...
	<main class="app-content">
		<div class="app-title">
	        <ul class="app-breadcrumb breadcrumb side">
                ...
                @endif
                <li class="breadcrumb-item active"><a href="{{ route('setting.address.district.create', array('province_id' => $province->province_id)) }}">{{ __('item.add_district') }}</a></li>
	        </ul>
      	</div>
        <div class="col-lg-12">
            @include('flash/message')
          	<div class="panel-body bg-white rounded overflow_hidden p-4">
          		<h3 class="text-dark mb-4">{{ __('item.add_district') }}</h3><hr/>
                {!! Form::open(array('url' => route('setting.address.district.store',array('province_id'=>$province->province_id)), 'method'=>'POST', 'enctype' => 'multipart/form-data', 'class' => 'row form-horizontal')) !!}
