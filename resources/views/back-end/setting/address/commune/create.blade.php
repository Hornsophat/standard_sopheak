...
@section('title',__('item.add_commune'))
@section('style')
	...
	<main class="app-content">
		<div class="app-title">
	        <ul class="app-breadcrumb breadcrumb side">
                ...
                @endif
                <li class="breadcrumb-item active"><a href="{{ route('setting.address.commune.create', array('district_id' => $district->dis_id)) }}">{{ __('item.add_commune') }}</a></li>
	        </ul>
      	</div>
        <div class="col-lg-12">
            @include('flash/message')
          	<div class="panel-body bg-white rounded overflow_hidden p-4">
                ...
                {!! Form::open(array('url' => route('setting.address.commune.store',array('district_id'=>$district->dis_id)), 'method'=>'POST', 'enctype' => 'multipart/form-data', 'class' => 'row form-horizontal')) !!}
