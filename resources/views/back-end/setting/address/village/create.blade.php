...
@section('title',__('item.add_village'))
@section('style')
	...
	<main class="app-content">
		<div class="app-title">
	        <ul class="app-breadcrumb breadcrumb side">
                ...
                @endif
                <li class="breadcrumb-item active"><a href="{{ route('setting.address.village.create', array('commune_id' => $commune->com_id)) }}">{{ __('item.add_village') }}</a></li>
	        </ul>
      	</div>
        <div class="col-lg-12">
            @include('flash/message')
          	<div class="panel-body bg-white rounded overflow_hidden p-4">
                ...
                {!! Form::open(array('url' => route('setting.address.village.store',array('commune_id'=>$commune->com_id)), 'method'=>'POST', 'enctype' => 'multipart/form-data', 'class' => 'row form-horizontal')) !!}
